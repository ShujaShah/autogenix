...
export const EditorNameInput = ({workflowId}: {workflowId: string}) => {
  ...
  if(isEditing){
    return <Input disabled = {updateWorkflow.isPending} ref = {inputRef} value={name} onChange={(e)=> setName(e.target.value)} onBlur={handleSave} onKeyDown={handleKeyDown} className="h-7 w-auto min-w-[100px] px-2"/>
  }
